    ...
    <>
      ...
      {cartLoaded && cart && (
        <div className="mx-4 md:mx-8 lg:mx-60 mt-8 max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flow-root">
              <ul className="-my-4 md:-my-6 divide-y  divide-gray-200">
                {cart.length === 0 ? (
                  <div className="flex flex-col bg-white rounded-lg shadow-md p-4 items-center mt-10 justify-center">
                    <img
                      src={emptycart}
                      alt="Empty Cart"
                      className="w-52 h-52"
          ...
          <div className="mx-auto  mt-20 md:mt-10 max-w-7xl bg-white rounded-lg shadow-md p-4 sm:px-4  lg:px-4">
            {cart.length !== 0 ? (
              <div>
                {" "}
                <div className="flex justify-between text-base md:text-lg font-medium text-gray-900">
